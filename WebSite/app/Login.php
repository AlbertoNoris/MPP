...
<?php
session_start();
$dbconn = pg_connect("host=containers-us-west-28.railway.app port=5622 dbname=railway user=postgres password=4jydJNhTKikgVEnDhUlv")  or header("Location: ../app/indexE.php?er=100");
?>
<html>
    <head></head>
<body>
